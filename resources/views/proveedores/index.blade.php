...
@section("content")
    <div class="container-fluid py-5 bg-dark" style="min-height: 100vh;">
        <div class="row justify-content-center mb-4">
            <div class="col-md-8">
                <h1 class="text-center text-white fw-bold">Suministrados de los Proveedores</h1>
            </div>
        </div>
            ...
            <div class="col-md-10">
                <div class="rounded shadow-lg bg-gradient-to-b from-gray-800 to-gray-900 p-4">
                    <table class="table table-hover text-white align-middle">
                        ...
                        <tr>
                            <th class="fw-bold text-uppercase text-center" style="letter-spacing: 1px;">Proveedor</th>
                            <th class="fw-bold text-uppercase text-center" style="letter-spacing: 1px;">Suministrados</th>
                        </tr>
                        </thead>
