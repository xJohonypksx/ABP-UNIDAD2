            ...
            <div class="col-md-10">
                <div class="rounded shadow-lg bg-gradient-to-b from-gray-800 to-gray-900 p-4">
                    <table class="table table-hover text-white align-middle">
                        ...
                        <tr>
                            <th class="fw-bold text-uppercase text-center" style="letter-spacing: 1px;">Persona</th>
                            <th class="fw-bold text-uppercase text-center" style="letter-spacing: 1px;">Empleado</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($vendedores as $index => $vendedor)
                            <tr class="border-bottom border-gray-700">
                                ...
                                <td class="text-center fs-5">{{ $vendedor->id_vendedor }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
