            ...
            <div class="col-md-10">
                <div class="rounded shadow-lg bg-gradient-to-b from-gray-800 to-gray-900 p-4">
                    <table class="table table-hover text-white align-middle">
                        ...
                        <tr>
                            <th class="fw-bold text-uppercase text-center" style="letter-spacing: 1px;">Numero de Producto</th>
                            <th class="fw-bold text-uppercase text-center" style="letter-spacing: 1px;">Nombre del Producto</th>
                        </tr>
                        </thead>
